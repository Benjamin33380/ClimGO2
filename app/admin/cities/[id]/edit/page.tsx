...
export default function EditCityPage() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          interventionsTitle: data.interventionsTitle,
          interventionsDescription: data.interventionsDescription,
          whyChooseTitle: data.whyChooseTitle,
          whyChooseDescription1: data.whyChooseDescription1,
          whyChooseDescription2: data.whyChooseDescription2,
          whyChooseDescription3: data.whyChooseDescription3,
          ...
          faqQuestions: Array.isArray(data.faqQuestions) ? data.faqQuestions : [{ question: '', answer: '' }],
          section1Title: data.section1Title,
          section1Content: Array.isArray(data.section1Content) ? data.section1Content : [''],
          section2Title: data.section2Title,
          section2Content: Array.isArray(data.section2Content) ? data.section2Content : [''],
          section3Title: data.section3Title,
          section3Content: Array.isArray(data.section3Content) ? data.section3Content : [''],
          section4Title: data.section4Title,
          section4Content: Array.isArray(data.section4Content) ? data.section4Content : [''],
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        router.push(`/admin/cities/${params.id}/view`);
      } else {
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Modifier la page : {formData.cityName}</h1>
            </div>
            <div className="flex gap-2">
              <Link
                href={`/admin/cities/${params.id}/view`}
                className="bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors"
              >
                Annuler
              </Link>
              <Link
                href={`/villes/${formData.slug}`}
                target="_blank"
