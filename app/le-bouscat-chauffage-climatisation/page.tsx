  ...
  return (
    <main className="px-0">
      <section className="w-full">
        <Hero ville="Le Bouscat" backgroundImage="/villes/bou.jpg" />
      </section>
      <nav className="max-w-7xl mx-auto px-4 text-sm text-gray-600 my-6" aria-label="Fil d'Ariane">
        <ol className="list-reset flex items-center space-x-2">
          ...
          <li className="text-gray-500">Le Bouscats</li>
        </ol>
      </nav>
      <section className="my-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Le Bouscat, commune résidentielle proche de Bordeaux</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Le Bouscat, avec son ambiance résidentielle et ses belles maisons, mérite des installations thermiques sur-mesure.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            ClimGO vous accompagne pour équiper votre maison ou appartement du Bouscat avec des solutions performantes, esthétiques et discrètes.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Forts de notre expérience locale et de nos certifications, nous garantissons des installations durables, économiques et parfaitement adaptées aux besoins spécifiques des logements du Bouscat.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/70 backdrop-blur-lg p-8 rounded-xl shadow-xl max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Nos interventions au Bouscat</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Du quartier Saint-Antoine aux abords du parc de la Chêneraie, nos équipes interviennent partout au Bouscat avec précision. Chaque chantier est réalisé avec soin, pour un confort optimal été comme hiver.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/80 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Pourquoi choisir ClimGO au Bouscat ?</h2>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              Faire appel à ClimGO au Bouscat, c’est faire le choix d’un savoir-faire local et d’un accompagnement complet.
            </p>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 my-12">
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <p className="text-white leading-relaxed text-center">
            Résidences familiales, logements collectifs, et zones pavillonnaires : nous maîtrisons les contraintes thermiques de tous les types d’habitat au Bouscat.
          </p>
        </div>
        ...
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-4 text-center">Aides financières au Bouscat</h2>
          <p className="text-white leading-relaxed text-center">
            MaPrimeRénov’, CEE, Éco-PTZ… au Bouscat, de nombreuses aides sont accessibles. Nous vous aidons à maximiser vos subventions sans vous perdre dans la paperasse.
          </p>
        </div>
      </div>
    ...
    <p className="text-[#03144a] leading-relaxed text-center">
     ...
     <section className="text-center my-20">
        ...
        <p className="text-gray-800 leading-relaxed mb-6 text-center">
          Votre logement au Bouscat mérite une installation thermique performante. Demandez votre devis gratuit.
        </p>
        <a
          href="/contact"
          className="inline-block bg-[#03144a] text-white font-semibold py-3 px-8 rounded-lg hover:bg-[#021037] transition"
        >
          Demandez votre devis gratuit au Bouscat
        </a>
      </section>
