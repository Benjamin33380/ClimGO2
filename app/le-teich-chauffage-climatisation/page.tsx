  ...
  return (
    <main className="px-0">
      <section className="w-full">
        <Hero ville="Le Teich" backgroundImage="/villes/teich.jpg" />
      </section>
      <nav className="max-w-7xl mx-auto px-4 text-sm text-gray-600 my-6" aria-label="Fil d'Ariane">
        <ol className="list-reset flex items-center space-x-2">
          ...
          <li className="text-gray-500">Le Teich</li>
        </ol>
      </nav>
      <section className="my-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Bassin d&apos;Arcachon, Habitant du Teich</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Entre la Leyre et le bassin, Le Teich se distingue par son environnement naturel préservé et sa richesse en faune et flore. Que vous viviez dans le Bourg, à Lamothe, ClimGO s’adapte à chaque habitat pour assurer votre confort thermique.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
      ...
      >
        ...
        <div className="relative z-10 bg-white/70 backdrop-blur-lg p-8 rounded-xl shadow-xl max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Nos interventions au Teich</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Du Bourg à Lamothe, nous couvrons tous les secteurs du Teich. Nos solutions s’adaptent aux constructions neuves comme aux maisons anciennes, avec un souci constant d’efficacité et de durabilité. Où que vous soyez, nous vous garantissons un service réactif et personnalisé.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/80 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Pourquoi choisir ClimGO au Teich ?</h2>
            ...
            <p className="text-gray-800 leading-relaxed text-center">
              Notre proximité nous permet d&apos;intervenir rapidement sur tout le Teich, pour des dépannages ou des installations urgentes sans attente.
            </p>
          </section>
        </div>
      </div>
              ...
              questions={[
                {
                  ...
                  answer: "Nous assurons l’installation, l’entretien et le dépannage de systèmes de chauffage, climatisation et production d’eau chaude au Teich et ses lieux-dits.",
                },
                {
                ...
                },
                {
                  ...
                  answer: "Absolument. Nos techniciens se déplacent dans tous les lieux-dits du Teich, comme Lamothe ou le Bourg.",
                }
              ]}
            />
          </section>
  ...
  <div className="bg-white/80 backdrop-blur-md rounded-lg shadow-md p-6">
    ...
    <p className="text-[#03144a] leading-relaxed text-center">
     ...
     <section className="text-center my-20">
        ...
        >
          Demandez votre devis gratuit au Teich
        </a>
      </section>
