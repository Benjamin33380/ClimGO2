export const metadata = {
  ...
  openGraph: {
    ...
    description: "Installation, entretien et dépannage de chauffage, climatisation, chauffe-eau et pompes à chaleur à Villenave-d'Ornon. Profitez d'un service local, certifié RGE.",
    url: "https://www.climgo.fr/zones-desservies/villenave-d-ornon",
    siteName: "ClimGO",
    locale: "fr_FR",
    type: "website",
    images: [
      {
        url: "https://www.climgo.fr/images/og-image-villenave-d-ornon.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Chauffage, Climatisation et PAC à Villenave-d'Ornon - ClimGO",
    description: "Installation, entretien et dépannage de chauffage, climatisation, chauffe-eau et pompes à chaleur à Villenave-d'Ornon. Profitez d'un service local, certifié RGE.",
    images: ["https://www.climgo.fr/images/og-image-villenave-d-ornon.jpg"]
  },
  metadataBase: new URL("https://www.climgo.fr"),
  alternates: {
    canonical: "/zones-desservies/villenave-d-ornon"
  }
};
    ...
    <>
      <Script type="application/ld+json" id="ld-json-schema" strategy="afterInteractive">
        {JSON.stringify({
          ...
          "@type": "LocalBusiness",
          "name": "ClimGO",
          "image": "https://www.climgo.fr/images/og-image-villenave-d-ornon.jpg",
          "@id": "https://www.climgo.fr/zones-desservies/villenave-d-ornon",
          "url": "https://www.climgo.fr/zones-desservies/villenave-d-ornon",
