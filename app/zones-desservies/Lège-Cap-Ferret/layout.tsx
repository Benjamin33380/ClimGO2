export const metadata = {
  ...
  description: "Installation, entretien et dépannage de chauffage, climatisation, chauffe-eau et pompes à chaleur à Lège-Cap-Ferret. Profitez d'un service local, certifié RGE.",
  keywords: [
  ...
  openGraph: {
    ...
    description: "Installation, entretien et dépannage de chauffage, climatisation, chauffe-eau et pompes à chaleur à Lège-Cap-Ferret. Profitez d'un service local, certifié RGE.",
    url: "https://www.climgo.fr/zones-desservies/lege",
    siteName: "ClimGO",
    locale: "fr_FR",
    type: "website",
    images: [
      {
        url: "https://www.climgo.fr/images/og-image-lege.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Chauffage, Climatisation et PAC à Lège-Cap-Ferret - ClimGO",
    description: "Installation, entretien et dépannage de chauffage, climatisation, chauffe-eau et pompes à chaleur à Lège-Cap-Ferret. Profitez d'un service local, certifié RGE.",
    images: ["https://www.climgo.fr/images/og-image-lege.jpg"]
  },
  metadataBase: new URL("https://www.climgo.fr"),
  alternates: {
    canonical: "/zones-desservies/lege"
  }
};
    ...
    <>
      <Script type="application/ld+json" id="ld-json-schema" strategy="afterInteractive">
        {JSON.stringify({
          ...
          "@type": "LocalBusiness",
          "name": "ClimGO",
          "image": "https://www.climgo.fr/images/og-image-lege.jpg",
          "@id": "https://www.climgo.fr/zones-desservies/lege",
          "url": "https://www.climgo.fr/zones-desservies/lege",
