export const metadata = {
  ...
  openGraph: {
    ...
    description: "Installation, entretien et dépannage de chauffage, climatisation, chauffe-eau et pompes à chaleur à Lanton. Profitez d'un service local, certifié RGE.",
    url: "https://www.climgo.fr/zones-desservies/lanton",
    siteName: "ClimGO",
    locale: "fr_FR",
    type: "website",
    images: [
      {
        url: "https://www.climgo.fr/images/og-image-lanton.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    title: "Chauffage, Climatisation et PAC à Lanton - ClimGO",
    description: "Installation, entretien et dépannage de chauffage, climatisation, chauffe-eau et pompes à chaleur à Lanton. Profitez d'un service local, certifié RGE.",
    images: ["https://www.climgo.fr/images/og-image-lanton.jpg"]
  },
  metadataBase: new URL("https://www.climgo.fr"),
  alternates: {
    canonical: "/zones-desservies/lanton"
  }
};
    ...
    <>
      <Script type="application/ld+json" id="ld-json-schema" strategy="afterInteractive">
        {JSON.stringify({
          ...
          "@type": "LocalBusiness",
          "name": "ClimGO",
          "image": "https://www.climgo.fr/images/og-image-lanton.jpg",
          "@id": "https://www.climgo.fr/zones-desservies/lanton",
          "url": "https://www.climgo.fr/zones-desservies/lanton",
