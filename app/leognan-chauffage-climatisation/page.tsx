...
export default function Leognan() {
  return (
    <main className="px-0">
      <section className="w-full">
        <Hero ville="Léognan" backgroundImage="/villes/leo.webp" />
      </section>
      <nav className="max-w-7xl mx-auto px-4 text-sm text-gray-600 my-6" aria-label="Fil d'Ariane">
        <ol className="list-reset flex items-center space-x-2">
          ...
          <li className="text-gray-500">Léognan</li>
        </ol>
      </nav>
      <section className="my-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Léognan, charme viticole et qualité de vie au sud de Bordeaux</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Léognan, réputée pour ses vignobles et son cadre de vie paisible, est une commune où confort thermique et esthétique vont de pair.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Que vous viviez près du centre, du quartier Larrieu ou vers les châteaux viticoles, ClimGO vous accompagne pour des installations performantes.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Nos réalisations à Léognan s’intègrent parfaitement à l’architecture locale, avec un savoir-faire alliant efficacité et discrétion.
          </p>
        </div>
      </section>

      <section className="my-20">
       <GoogleReviews ville="Léognan" />
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/70 backdrop-blur-lg p-8 rounded-xl shadow-xl max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Nos interventions à Léognan</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            De Larrieu à l’Ornon, nous intervenons dans toute la commune avec précision. Chaque installation est optimisée pour garantir confort et performance durable.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/80 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Pourquoi choisir ClimGO à Léognan ?</h2>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              Faire appel à ClimGO à Léognan, c’est s’assurer une expertise locale adaptée aux logements résidentiels comme aux propriétés viticoles.
            </p>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              Pompes à chaleur, climatisation gainable, chauffe-eaux économiques : nous concevons des solutions sur-mesure pour chaque besoin.
            </p>
            <p className="text-gray-800 leading-relaxed text-center">
              Notre présence à proximité garantit une intervention rapide et un suivi personnalisé tout au long de votre projet.
            </p>
          </section>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 my-12">
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <p className="text-white leading-relaxed text-center">
            Maisons familiales, propriétés viticoles, pavillons modernes : nous adaptons chaque installation aux spécificités des habitations de Léognan.
          </p>
        </div>
        ...
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-4 text-center">Aides financières à Léognan</h2>
          <p className="text-white leading-relaxed text-center">
            Les habitants de Léognan peuvent bénéficier de dispositifs comme MaPrimeRénov’, CEE ou Éco-PTZ. ClimGO vous aide à en tirer le meilleur parti.
          </p>
        </div>
      </div>
            ...
            <Faq
              questions={[
                ...
                },
                {
                  ...
                  answer: "Oui, nous adaptons nos installations aux bâtiments techniques et habitations des domaines viticoles de Léognan."
                }
              ]}
            />
          </section>
    ...
    <p className="text-[#03144a] leading-relaxed text-center">
     ...
     <section className="text-center my-20">
        ...
        <p className="text-gray-800 leading-relaxed mb-6 text-center">
          Votre logement à Léognan mérite une installation thermique fiable et esthétique. Contactez notre équipe pour un devis personnalisé.
        </p>
        <a
          href="/contact"
          className="inline-block bg-[#03144a] text-white font-semibold py-3 px-8 rounded-lg hover:bg-[#021037] transition"
        >
          Demandez votre devis gratuit à Léognan
        </a>
      </section>
