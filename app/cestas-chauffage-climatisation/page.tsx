  ...
  return (
    <main className="px-0">
      <section className="w-full">
        <Hero ville="Cestas" backgroundImage="/villes/cestas.jpg" />
      </section>
      <nav className="max-w-7xl mx-auto px-4 text-sm text-gray-600 my-6" aria-label="Fil d'Ariane">
        <ol className="list-reset flex items-center space-x-2">
          ...
          <li className="text-gray-500">Cestas</li>
        </ol>
      </nav>
      <section className="my-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Cestas, cadre résidentiel et confort thermique maîtrisé</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Cestas est une commune résidentielle entourée de forêts, appréciée pour son calme, ses grands terrains et sa qualité de vie. Ses maisons individuelles nécessitent des solutions de chauffage et de climatisation fiables et performantes.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Que vous soyez situé près du Bourg, de Gazinet ou de Pierroton, ClimGO conçoit et installe des équipements thermiques adaptés à votre habitat.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Avec notre expérience locale et nos certifications, nous assurons des installations durables, économiques et parfaitement intégrées aux exigences des habitations de Cestas.
          </p>
        </div>
      </section>

      <section className="my-20">
        <GoogleReviews ville="Cestas" />
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/70 backdrop-blur-lg p-8 rounded-xl shadow-xl max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Nos interventions à Cestas</h2>
          <p className="text-gray-800 leading-relaxed text-center">
      ...
      >
        ...
        <div className="relative z-10 bg-white/80 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Pourquoi choisir ClimGO à Cestas ?</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 my-12">
        ...
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-4 text-center">Aides financières à Cestas</h2>
          <p className="text-white leading-relaxed text-center">
              ...
              questions={[
                {
                  ...
                  answer: "Pompes à chaleur air/eau, climatisation réversible, chauffe-eaux thermodynamiques, radiateurs performants… Nous intervenons dans tous les quartiers de Cestas.",
                },
                {
    ...
    <p className="text-[#03144a] leading-relaxed text-center">
     ...
     <section className="text-center my-20">
        ...
        <p className="text-gray-800 leading-relaxed mb-6 text-center">
          Votre logement à Cestas mérite une installation thermique fiable et performante. Obtenez un devis gratuit personnalisé.
        </p>
        <a
          href="/contact"
          className="inline-block bg-[#03144a] text-white font-semibold py-3 px-8 rounded-lg hover:bg-[#021037] transition"
        >
          Demandez votre devis gratuit à Cestas
        </a>
      </section>
