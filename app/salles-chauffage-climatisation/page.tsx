  ...
  return (
    <main className="px-0">
      <section className="w-full">
        <Hero ville="Salles" backgroundImage="/villes/salles.jpg" />
      </section>
      <nav className="max-w-7xl mx-auto px-4 text-sm text-gray-600 my-6" aria-label="Fil d'Ariane">
        <ol className="list-reset flex items-center space-x-2">
          ...
          <li className="text-gray-500">Salles</li>
        </ol>
      </nav>
      <section className="my-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Proche du Val de l’Eyre, Habitant de Salles</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Située entre la forêt des Landes et le bassin d&apos;Arcachon, la commune de Salles se caractérise par ses quartiers typiques et ses hameaux pittoresques. Ce secteur offre un cadre de vie paisible, idéal pour les familles et les amoureux de la nature.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Que vous résidiez dans le centre-ville, Lanot, Caplanne, Bilos, Lavignolle, les quartiers environnants ou les hameaux de Salles, ClimGO vous propose des solutions de chauffage, climatisation et eau chaude sanitaire adaptées aux spécificités locales, tout en respectant les normes énergétiques les plus strictes.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Grâce à notre proximité géographique et notre connaissance du tissu local, nous vous accompagnons dans chaque étape de votre projet, en prenant en compte les contraintes d&apos;isolation, de consommation et de configuration de votre logement typique de Salles ou de ses alentours.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/80 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Pourquoi choisir ClimGO à Salles ?</h2>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              En faisant appel à ClimGO, vous bénéficiez d’un accompagnement de proximité, pensé pour les spécificités de Salles et ses alentours. Nos techniciens sont certifiés RGE et QualiPAC, garantissant qualité et durabilité des installations.
            </p>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 my-12">
        ...
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-4 text-center">Aides financières à Salles</h2>
          <p className="text-white leading-relaxed text-center">
        ...
        <div className="relative z-10 bg-white/60 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto px-4">
          <section>
            ...
            <Faq
              questions={[
                {
                  question: "Quels services proposez-vous à Salles ?",
                  answer: "Nous proposons l'installation, l'entretien et la maintenance de systèmes de chauffage, climatisation, chauffe-eau et pompes à chaleur à Salles.",
                },
                {
                ...
                {
                  question: "Intervenez-vous dans les zones rurales autour de Salles ?",
                  answer: "Tout à fait. Nous couvrons Salles et ses alentours pour assurer un service de proximité.",
                }
              ]}
            />
          </section>
  ...
  <div className="bg-white/80 backdrop-blur-md rounded-lg shadow-md p-6">
    ...
    <p className="text-[#03144a] leading-relaxed text-center">
     ...
     <section className="text-center my-20">
        ...
        >
          Demandez votre devis gratuit à Salles
        </a>
      </section>
