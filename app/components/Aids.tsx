          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-4 justify-start ml-24">
                <div className="bg-[#f8f8f9] rounded-full w-12 h-12 flex items-center justify-center shrink-0">
            ...
            <div className="text-center mt-12">
              <Link href="/aides-etat/" className="bg-[#f8f8f9] text-black px-8 py-3 rounded-full hover:opacity-90 transition-opacity font-medium text-lg">
