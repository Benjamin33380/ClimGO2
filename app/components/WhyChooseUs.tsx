        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-transparent rounded-lg p-6 hover:shadow-lg transition-all duration-300">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#f8f8f5] mb-3">Expertise</h3>
          ...
          <div className="bg-transparent rounded-lg p-6 hover:shadow-lg transition-all duration-300">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#f8f8f5] mb-3">Accompagnement Personnalisé</h3>
              <p className="text-[#f8f8f9] text-sm leading-relaxed">
          ...
          <div className="bg-transparent rounded-lg p-6 hover:shadow-lg transition-all duration-300">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#f8f8f9] mb-3">Discrétion et Confiance</h3>
              <p className="text-[#f8f8f9] text-sm leading-relaxed">
          ...
          <div className="bg-transparent rounded-lg p-6 hover:shadow-lg transition-all duration-300">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-[#f8f8f9] mb-3">Engagement Durable</h3>
              <p className="text-[#f8f8f9] text-sm leading-relaxed">
