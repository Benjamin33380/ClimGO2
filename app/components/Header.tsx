...
import { FiHome, FiSettings, FiInfo, FiBookOpen, FiMail, FiPhone } from 'react-icons/fi';
...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50">
      {/* Header moderne fusionné */}
      <div className="w-full bg-[#03144a]/95 backdrop-blur-md shadow-lg">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              <Link href="/" className="text-white hover:text-blue-200 transition-colors text-base font-medium">
                Accueil
              </Link>
              
              <div className="relative group">
                <Link href="/nos-services" className="text-white hover:text-blue-200 transition-colors text-base font-medium flex items-center">
                  Nos Services
                  <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                  </svg>
                </Link>
                <ul className="absolute top-full mt-2 w-56 rounded-xl shadow-xl bg-white border border-gray-100 left-0 invisible group-hover:opacity-100 group-hover:visible group-hover:translate-y-1 transition-all duration-200 pointer-events-auto z-50 overflow-hidden">
                  <li>
                    <Link href="/chauffage" className="block px-4 py-3 text-base text-[#03144a] hover:bg-blue-50 hover:text-blue-600 transition-colors">
                      Chauffage
                    </Link>
                  </li>
                  <li>
                    <Link href="/climatisation" className="block px-4 py-3 text-base text-[#03144a] hover:bg-blue-50 hover:text-blue-600 transition-colors">
                      Climatisation
                    </Link>
                  </li>
                  <li>
                    <Link href="/eau-chaude-sanitaire" className="block px-4 py-3 text-base text-[#03144a] hover:bg-blue-50 hover:text-blue-600 transition-colors">
                      Eau chaude sanitaire
                    </Link>
                  </li>
                  <li>
                    <Link href="/maintenance" className="block px-4 py-3 text-base text-[#03144a] hover:bg-blue-50 hover:text-blue-600 transition-colors">
                      Maintenance
                    </Link>
                  </li>
                </ul>
            ...
            {/* CTA et réseaux sociaux Desktop */}
            <div className="hidden lg:flex items-center space-x-6">
              {/* Réseaux sociaux */}
              <div className="flex items-center space-x-3">
                <Link href="https://www.facebook.com/profile.php?id=61578576031066" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors">
                  <Image src="/fb.png" alt="Facebook" width={16} height={16} />
                </Link>
                <Link href="https://www.instagram.com/climgo_climatisation_chauffage" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors">
                  <Image src="/insta.png" alt="Instagram" width={16} height={16} />
                </Link>
                <Link href="https://www.linkedin.com/company/climgo/about/?viewAsMember=true" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/10 hover:bg-white/20 transition-colors">
                  <Image src="/in.png" alt="LinkedIn" width={16} height={16} />
                </Link>
              </div>
              
              {/* Bouton d'appel */}
              <Link href="tel:0766460008" className="flex items-center space-x-2 bg-white text-[#03144a] px-6 py-3 rounded-xl font-medium hover:bg-gray-100 transition-colors shadow-lg hover:shadow-xl transform hover:scale-105">
            ...
            <div className="lg:hidden flex items-center space-x-4">
              <Link href="tel:0766460008" className="flex items-center space-x-2 bg-white text-[#03144a] px-4 py-2 rounded-lg font-medium">
                <FiPhone className="w-4 h-4" />
      ...
      {/* Mobile Menu Overlay */}
      <div className={`fixed inset-0 z-10 lg:hidden transition-all duration-300 ${
