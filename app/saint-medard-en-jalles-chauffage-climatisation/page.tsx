...
export default function medard() {
  return (
    <main className="px-0">
      <section className="w-full">
        <Hero ville="Saint-Médard-en-Jalles" backgroundImage="/villes/smej.webp" />
      </section>
      <nav className="max-w-7xl mx-auto px-4 text-sm text-gray-600 my-6" aria-label="Fil d'Ariane">
        <ol className="list-reset flex items-center space-x-2">
          ...
          <li className="text-gray-500">Saint-Médard-en-Jalles</li>
        </ol>
      </nav>
      <section className="my-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Saint-Médard-en-Jalles, entre forêt et dynamisme technologique</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Située entre Bordeaux et les Landes, Saint-Médard-en-Jalles conjugue zones résidentielles calmes et pôles d’activités technologiques.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Que vous soyez vers Hastignan, Cérillan ou Corbiac, ClimGO propose des installations sur-mesure et efficaces.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Nos systèmes s’intègrent aussi bien dans les maisons traditionnelles que dans les logements récents des quartiers pavillonnaires.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/70 backdrop-blur-lg p-8 rounded-xl shadow-xl max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Nos interventions à Saint-Médard-en-Jalles</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            De Gajac au Bourg en passant par Magudas, nous intervenons dans tous les quartiers pour vous assurer confort et sérénité.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/80 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Pourquoi choisir ClimGO à Saint-Médard-en-Jalles ?</h2>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              Faire appel à ClimGO à Saint-Médard-en-Jalles, c’est choisir un acteur local qui comprend les spécificités thermiques de la commune.
            </p>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              Nos équipements sont adaptés à l’environnement résidentiel : efficaces, durables, et esthétiques.
            </p>
            <p className="text-gray-800 leading-relaxed text-center">
              Vous bénéficiez d’un accompagnement humain, rigoureux et réactif, du devis à la maintenance.
            </p>
          </section>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 my-12">
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <p className="text-white leading-relaxed text-center">
            Maisons individuelles, pavillons récents ou résidences en lotissement : nous adaptons nos prestations aux réalités de Saint-Médard-en-Jalles.
          </p>
        </div>
        ...
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-4 text-center">Aides financières à Saint-Médard-en-Jalles</h2>
          <p className="text-white leading-relaxed text-center">
            Nous vous aidons à obtenir MaPrimeRénov’, les CEE, ou l’Éco-PTZ pour financer vos projets thermiques à Saint-Médard.
          </p>
        </div>
      </div>
            ...
            <Faq
              questions={[
                ...
                },
                {
                  ...
                  answer: "Absolument. De Magudas à Corbiac, nous couvrons toute la commune.",
                }
              ]}
            />
          </section>
    ...
    <p className="text-[#03144a] leading-relaxed text-center">
     ...
     <section className="text-center my-20">
        ...
        <p className="text-gray-800 leading-relaxed mb-6 text-center">
          Vous résidez à Saint-Médard-en-Jalles ? Faites appel à ClimGO pour une solution thermique fiable, locale et personnalisée.
        </p>
        <a
          href="/contact"
          className="inline-block bg-[#03144a] text-white font-semibold py-3 px-8 rounded-lg hover:bg-[#021037] transition"
        >
          Demandez votre devis gratuit à Saint-Médard-en-Jalles
        </a>
      </section>
