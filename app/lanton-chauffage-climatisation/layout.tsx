...
<Script type="application/ld+json" id="ld-json-schema" strategy="afterInteractive">
  {JSON.stringify({
    ...
    "description": "Installation, dépannage et entretien de climatisations, pompes à chaleur et chauffe-eau à Lanton. ClimGO, votre artisan local pour un confort thermique optimal.",
    "sameAs": [
