...
export default function Bouliac() {
  return (
    <main className="px-0">
      <section className="w-full">
        <Hero ville="Bouliac" backgroundImage="/villes/liac.jpg" />
      </section>
      <nav className="max-w-7xl mx-auto px-4 text-sm text-gray-600 my-6" aria-label="Fil d'Ariane">
        <ol className="list-reset flex items-center space-x-2">
          ...
          <li className="text-gray-500">Bouliac</li>
        </ol>
      </nav>
      <section className="my-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Bouliac, entre vignobles et panorama sur Bordeaux</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Bouliac offre un cadre résidentiel paisible avec vue sur Bordeaux, idéal pour des solutions de chauffage et climatisation haut de gamme.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            ClimGO intervient à Bouliac pour proposer des équipements thermiques adaptés à l’architecture résidentielle locale.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Notre expérience à Bouliac garantit une installation discrète, efficace et parfaitement intégrée à votre cadre de vie.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/70 backdrop-blur-lg p-8 rounded-xl shadow-xl max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Nos interventions à Bouliac</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Du centre-bourg aux hauteurs de Bouliac, nous intervenons avec précision et discrétion pour répondre aux besoins thermiques de chaque habitation.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/80 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Pourquoi choisir ClimGO à Bouliac ?</h2>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              Faire appel à ClimGO à Bouliac, c’est faire le choix de la proximité, du conseil et d’un savoir-faire reconnu.
            </p>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              Nos équipements s’intègrent dans tous les types de logements bouliacais, avec discrétion et performance.
            </p>
            <p className="text-gray-800 leading-relaxed text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 my-12">
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <p className="text-white leading-relaxed text-center">
            Maisons récentes, résidences ou immeubles anciens : nous adaptons chaque installation aux spécificités des logements de Bouliac.
          </p>
        </div>
        ...
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-4 text-center">Aides financières à Bouliac</h2>
          <p className="text-white leading-relaxed text-center">
            MaPrimeRénov’, CEE, Éco-PTZ… à Bouliac, bénéficiez des aides disponibles. ClimGO vous guide pas à pas dans vos démarches.
          </p>
        </div>
      </div>
              ...
              questions={[
                {
                  ...
                  answer: "Pompes à chaleur, climatisation, chauffe-eaux économiques… Nous intervenons dans tout Bouliac, du bas de la commune jusqu’aux coteaux.",
                },
                {
                  question: "Puis-je bénéficier d’aides locales à Bouliac ?",
                  answer: "Oui, certaines aides de Bordeaux Métropole sont disponibles en complément des subventions nationales. Nous vous aidons à en profiter.",
                },
                {
                  question: "Proposez-vous un service après-vente à Bouliac ?",
                  answer: "Absolument, notre équipe assure l’entretien régulier et la maintenance de vos équipements à Bouliac et alentours."
                }
              ]}
            />
          </section>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 my-12">
     ...
     <section className="text-center my-20">
        ...
        <p className="text-gray-800 leading-relaxed mb-6 text-center">
          Votre logement à Bouliac mérite le meilleur en confort thermique. Obtenez votre devis sans engagement.
        </p>
        <a
          href="/contact"
          className="inline-block bg-[#03144a] text-white font-semibold py-3 px-8 rounded-lg hover:bg-[#021037] transition"
        >
          Demandez votre devis gratuit à Bouliac
        </a>
      </section>
