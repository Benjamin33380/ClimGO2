...
export default function LeBarp() {
  return (
    <main className="px-0">
      <section className="w-full">
        <Hero ville="Le Barp" backgroundImage="/villes/barp.jpg" />
      </section>
      <nav className="max-w-7xl mx-auto px-4 text-sm text-gray-600 my-6" aria-label="Fil d'Ariane">
        <ol className="list-reset flex items-center space-x-2">
          ...
          <li className="text-gray-500">Le Barp</li>
        </ol>
      </nav>
      <section className="my-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Val de l&apos;Eyre, Habitant de Le Barp</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Située au cœur du Val de l&apos;Eyre, la commune du Barp se distingue par son environnement naturel remarquable, entre forêts de pins, rivières et sentiers boisés. Ce secteur, prisé pour son calme et sa qualité de vie, attire aussi bien les familles que les jeunes actifs souhaitant conjuguer confort et nature.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Que vous résidiez au centre-ville, à Haureuils, ou dans les hameaux environnants, ClimGO vous propose des solutions de chauffage, climatisation et eau chaude sanitaire pensées pour répondre aux besoins spécifiques des maisons du Val de l&apos;Eyre, tout en respectant les normes énergétiques les plus exigeantes.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Grâce à notre proximité géographique et notre connaissance du tissu local, nous vous accompagnons dans chaque étape de votre projet, en prenant en compte les contraintes d&apos;isolation, de consommation et de configuration de votre logement typique du Barp ou de ses alentours.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/80 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Pourquoi choisir ClimGO au Barp ?</h2>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              En faisant appel à ClimGO, vous bénéficiez d’un accompagnement de proximité, pensé pour les spécificités du Barp et ses alentours. Nos techniciens sont certifiés RGE et QualiPAC, garantissant qualité et durabilité des installations.
            </p>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 my-12">
        ...
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-4 text-center">Aides financières à Le Barp</h2>
          <p className="text-white leading-relaxed text-center">
        ...
        <div className="relative z-10 bg-white/60 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto px-4">
          <section>
            ...
            <Faq
              questions={[
                {
                  question: "Quels services proposez-vous à Le Barp ?",
                  answer: "Nous proposons l'installation, l'entretien et la maintenance de systèmes de chauffage, climatisation, chauffe-eau et pompes à chaleur à Le Barp.",
                },
                {
                ...
                {
                  question: "Intervenez-vous dans les zones rurales autour de Le Barp ?",
                  answer: "Tout à fait. Nous couvrons Le Barp et ses alentours pour assurer un service de proximité.",
                }
              ]}
            />
          </section>
  ...
  <div className="bg-white/80 backdrop-blur-md rounded-lg shadow-md p-6">
    ...
    <p className="text-[#03144a] leading-relaxed text-center">
     ...
     <section className="text-center my-20">
        ...
        >
          Demandez votre devis gratuit au Barp
        </a>
      </section>
