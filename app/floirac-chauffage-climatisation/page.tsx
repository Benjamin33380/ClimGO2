...
export default function Floirac() {
  return (
    <main className="px-0">
      <section className="w-full">
        <Hero ville="Floirac" backgroundImage="/villes/floirac.png" />
      </section>
      <nav className="max-w-7xl mx-auto px-4 text-sm text-gray-600 my-6" aria-label="Fil d'Ariane">
        <ol className="list-reset flex items-center space-x-2">
          ...
          <li className="text-gray-500">Floirac</li>
        </ol>
      </nav>
      <section className="my-20">
        <div className="max-w-4xl mx-auto px-4">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Floirac, ville verdoyante entre coteaux et fleuve</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Située entre les coteaux boisés et la Garonne, Floirac offre un cadre de vie paisible et verdoyant, idéal pour des installations énergétiques modernes.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            ClimGO vous accompagne à Floirac pour tous vos besoins en chauffage, climatisation ou production d’eau chaude.
          </p>
          <p className="text-gray-800 leading-relaxed text-center">
            Grâce à notre expertise locale, chaque solution est pensée pour s’adapter aux caractéristiques des logements floiracais.
          </p>
        </div>
      </section>

      <section className="my-20">
       <GoogleReviews ville="Floirac" />
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/70 backdrop-blur-lg p-8 rounded-xl shadow-xl max-w-3xl mx-auto">
          <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Nos interventions à Floirac</h2>
          <p className="text-gray-800 leading-relaxed text-center">
            Du coteau de la Garonne à la rue Jules Guesde, nous intervenons dans tous les quartiers de Floirac avec rigueur. Chaque installation est pensée pour optimiser votre confort thermique.
          </p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 bg-white/80 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto">
          <section className="mb-12">
            <h2 className="text-2xl font-semibold text-[#03144a] mb-4 text-center">Pourquoi choisir ClimGO à Floirac ?</h2>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              Faire appel à ClimGO à Floirac, c’est faire le choix de la proximité, du conseil et d’un savoir-faire reconnu.
            </p>
            <p className="text-gray-800 leading-relaxed mb-4 text-center">
              Nos équipements s’intègrent dans tous les types de logements floiracais, avec discrétion et performance.
            </p>
            <p className="text-gray-800 leading-relaxed text-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto px-4 my-12">
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-4 text-center">Types de logements desservis à Floirac</h2>
          <p className="text-white leading-relaxed text-center">
            Maisons récentes, résidences ou immeubles anciens : nous adaptons chaque installation aux spécificités des logements de Floirac.
          </p>
        </div>
        ...
        <div className="bg-[#03144a]/90 backdrop-blur-md rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-white mb-4 text-center">Aides financières à Floirac</h2>
          <p className="text-white leading-relaxed text-center">
            MaPrimeRénov’, CEE, Éco-PTZ… à Floirac, bénéficiez des aides disponibles. ClimGO vous guide pas à pas dans vos démarches.
          </p>
        </div>
      </div>
      ...
      >
        ...
        <div className="relative z-10 bg-white/60 backdrop-blur-md p-6 rounded-lg max-w-4xl mx-auto px-4">
          <section>
            <h2 className="text-2xl font-semibold text-[#03144a] mb-6 text-center">Mini FAQ locale à Floirac</h2>
            <Faq
              questions={[
                {
                ...
                },
                {
                  ...
                  answer: "Absolument, nous équipons aussi bien les maisons individuelles que les copropriétés ou immeubles à Floirac."
                }
              ]}
            />
          </section>
    ...
    <p className="text-[#03144a] leading-relaxed text-center">
     ...
     <section className="text-center my-20">
        ...
        <p className="text-gray-800 leading-relaxed mb-6 text-center">
          Votre logement à Floirac mérite le meilleur de la technologie thermique. Obtenez votre devis sans engagement.
        </p>
        <a
          href="/contact"
          className="inline-block bg-[#03144a] text-white font-semibold py-3 px-8 rounded-lg hover:bg-[#021037] transition"
        >
          Demandez votre devis gratuit à Floirac
        </a>
      </section>
